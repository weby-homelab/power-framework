...
- **Продакшн-якість** — 144 тести, 86%+ покриття, CodeQL сканування, OIDC-підписані PyPI релізи
...
| **CI/CD** | 144 тести, 86%+ покриття, CodeQL SAST, OIDC Trusted Publishing до PyPI |
