...
Прямий Windows runtime запуск не входив у Linux release pipeline `v3.4.5`;
...
historical evidence, а не поточним контрактом `v3.4.5`:
...
- [Нотатки релізу P.O.W.E.R. 3.4.5](docs/release-3.4.5.md) — поточний технічний scope,
