...
## ⚡ P.O.W.E.R. Agent Skill та встановлення

Ми запакували всі інструкції та скрипти лінтера й індексатора фреймворку P.O.W.E.R. у кастомний скілл для ШІ-агентів (Custom Skill). Він сумісний з Antigravity CLI та OpenCode.

### ⚙️ Встановлення однією командою

Щоб автоматично встановити скілл P.O.W.E.R. у ваш поточний робочий простір та інтегрувати його з агентами, виконайте наступну команду:
...
### 🔌 Ручне налаштування (Опціонально)
