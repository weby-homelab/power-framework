...
- **[CLI reference](docs/cli.md)** — усі 18 команд, flags і реальна exit behavior
...
| Функція                          | Що робить                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **CLI**                          | 18 команд, включно з `power cache` для гігієни namespace, `power import` для preflighted Markdown migration та `power memory` для явного proposal, approval, validation та history                                                                                                                                                                                                                                                                                           |
...
| `core/cli.py`                             | Командний рядок із 18 командами, включно з cache hygiene, preflighted import і transactional memory workflows                                                                                                                               |
