...
| **Гібридний пошук (v2.0)** | Багаторежимний пошук: FTS5 (BM25), Dense Vector Semantic (`fastembed` BGE-small-en-v1.5), Hybrid (RRF) та Hybrid Reranked (`cross-encoder` ms-marco-MiniLM-L-6-v2) з розширенням запитів (синоніми/LLM) та контекстним чанкуванням (`SemanticChunker`) |
...
| `core/embeddings.py` | Управління густими векторними ембеддінгами BGE-small на базі ONNX Runtime |
