#!/usr/bin/env python3
"""Run the local, content-free 3.7.9 -> 3.7.10 upgrade safety matrix.
...
def build_matrix(*, from_version: str = "3.7.9", to_version: str = "3.7.10") -> dict[str, Any]:
...
def build_interrupted_upgrade_matrix(
    *, from_version: str = "3.7.9", to_version: str = "3.7.10"
) -> dict[str, Any]:
