#!/usr/bin/env python3
"""Run the local, content-free 3.6.7 -> 3.7.5 upgrade safety matrix.
...
def build_matrix(*, from_version: str = "3.6.7", to_version: str = "3.7.5") -> dict[str, Any]:
...
def build_interrupted_upgrade_matrix(
    *, from_version: str = "3.6.7", to_version: str = "3.7.5"
) -> dict[str, Any]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--to-version", default="3.7.5")
