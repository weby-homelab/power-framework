...
- **Technical 3.3.2 release** — the machine-only M2–M5 gates, package and CI
...
- **[CLI reference](docs/cli.md)** — all 18 commands, flags, and actual exit behavior
...
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **CLI**                          | 18 commands, including `power doctor` for one-pass diagnosis, `power import` for preflighted Markdown migration and `power memory` for explicit proposal, approval, validation, and history                                                                                                                                                                                                                                                                                                                            |
...
> **POWER 3.3.2 evidence status:** the release contains the machine-only M2–M5
...
| `core/cli.py`                             | Command-line interface with 18 commands, including preflighted import and transactional memory workflows                                                                                                                           |
...
- [P.O.W.E.R. 3.3.2 release notes](docs/release-3.3.2.md) — current technical release
