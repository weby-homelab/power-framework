...
- **Stable 3.2.5 release** — hermetic tests and security checks are tracked in CI; the [P.O.W.E.R. 3.2.5 release](https://github.com/weby-homelab/power-framework/releases) records all completed gates.
...
- [P.O.W.E.R. 3.2.5 release notes](docs/release-3.2.5.md) — current release
