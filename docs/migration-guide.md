---
type: Resource
title: "AI Agent Migration Guide: Any Markdown Knowledge Base to P.O.W.E.R. v3.7.10"
...
# AI Agent Migration Guide: Any Markdown Knowledge Base to P.O.W.E.R. v3.7.10
...
This guide targets the `v3.7.10` release. Select the clean-install
...
This guide is verified against the `v3.7.10` release contract. CI checks these
...
Use the `v3.7.10` environment from Getting Started and verify:
