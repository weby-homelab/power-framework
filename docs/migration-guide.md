---
type: Resource
title: "AI Agent Migration Guide: Any Markdown Knowledge Base to P.O.W.E.R. v3.6.0"
...
# AI Agent Migration Guide: Any Markdown Knowledge Base to P.O.W.E.R. v3.6.0
...
This guide targets the `v3.6.0` release. Select the clean-install
...
This guide is verified against the `v3.6.0` release contract. CI checks these
...
Use the `v3.6.0` environment from Getting Started and verify:
