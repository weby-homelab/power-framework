---
type: Resource
title: "AI Agent Migration Guide: Any Markdown Knowledge Base to P.O.W.E.R. v3.7.1"
...
# AI Agent Migration Guide: Any Markdown Knowledge Base to P.O.W.E.R. v3.7.1
...
This guide targets the `v3.7.1` candidate release. Select the clean-install
...
This guide is verified against the `v3.7.1` candidate release contract. CI checks these
...
Use the `v3.7.1` environment from Getting Started and verify:
