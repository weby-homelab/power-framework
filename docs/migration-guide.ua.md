---
type: Resource
title: "Міграція для AI-агента: будь-яка Markdown-база знань у P.O.W.E.R. v3.7.4"
...
# Міграція для AI-агента: будь-яка Markdown-база знань у P.O.W.E.R. v3.7.4
...
Цей гід стосується кандидата релізу `v3.7.4`. Обирайте гід чистої
...
Цей гід перевірено проти contract кандидата `v3.7.4`. CI звіряє ці факти з
...
Використовуйте `v3.7.4` environment із clean-install гіда:
