---
type: Resource
title: "Міграція для AI-агента: будь-яка Markdown-база знань у P.O.W.E.R. v3.7.10"
...
# Міграція для AI-агента: будь-яка Markdown-база знань у P.O.W.E.R. v3.7.10
...
Цей гід стосується релізу `v3.7.10`. Обирайте гід чистої
...
Цей гід перевірено проти contract релізу `v3.7.10`. CI звіряє ці факти з
...
Використовуйте `v3.7.10` environment із clean-install гіда:
