---
type: Resource
title: "Міграція для AI-агента: будь-яка Markdown-база знань у P.O.W.E.R. v3.6.0"
...
# Міграція для AI-агента: будь-яка Markdown-база знань у P.O.W.E.R. v3.6.0
...
Цей гід стосується релізу `v3.6.0`. Обирайте гід чистої
...
Цей гід перевірено проти contract релізу `v3.6.0`. CI звіряє ці факти з
...
Використовуйте `v3.6.0` environment із clean-install гіда:
