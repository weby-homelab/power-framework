...
#### 🧠 Налаштування Моделі Embeddings (Оновлення v2.0.3)
...
Фреймворк P.O.W.E.R. (v2.0.3) включає вбудовану пошукову систему, яка підтримує п'ять стратегій:
...
| `_index.md` не має frontmatter               | Використовується стара версія фреймворку           | Оновіться до v2.0.3 або перезапустіть `generate_index`           |
