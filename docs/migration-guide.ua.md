---
type: Resource
title: "Міграція для AI-агента: будь-яка Markdown-база знань у P.O.W.E.R. v3.6.5"
...
# Міграція для AI-агента: будь-яка Markdown-база знань у P.O.W.E.R. v3.6.5
...
Цей гід стосується кандидата релізу `v3.6.5`. Обирайте гід чистої
...
Цей гід перевірено проти contract кандидата `v3.6.5`. CI звіряє ці факти з
...
Використовуйте `v3.6.5` environment із clean-install гіда:
