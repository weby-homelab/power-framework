...
Це канонічне налаштування локального stdio для P.O.W.E.R. `v3.7.9` на Linux.
Воно дає Codex, OpenCode, Gemini CLI, Claude Desktop і Claude Code один
і той самий процес сервера та однакову межу vault.

> **Контракт релізу:** використовуйте `v3.7.9` лише після появи signed tag та
> immutable wheel на [сторінці релізу GitHub](https://github.com/weby-homelab/power-framework/releases/tag/v3.7.9).
...
підтримуваними MCP onboarding платформами для `v3.7.9`.
...
"$POWER_PYTHON" -m pip install \
  "power-framework[mcp] @ https://github.com/weby-homelab/power-framework/releases/download/v3.7.9/power_framework-3.7.9-py3-none-any.whl"
