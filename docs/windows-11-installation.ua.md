# Інформаційний гід: встановлення P.O.W.E.R. 3.7.9 на Windows 11 25H2

> **Не є підтримуваною платформою для `v3.7.9`.** Підтримку Windows відкладено
...
> certification для Linux-релізу 3.7.9.

Цей гід встановлює P.O.W.E.R. `v3.7.9` в ізольоване віртуальне середовище,
...
> `v3.7.9` та immutable wheel зі [сторінки релізу GitHub](https://github.com/weby-homelab/power-framework/releases/tag/v3.7.9).
...
- P.O.W.E.R. `v3.7.9` має автоматизований кросплатформний regression-тест
...
```powershell
$ReleaseWheel = "https://github.com/weby-homelab/power-framework/releases/download/v3.7.9/power_framework-3.7.9-py3-none-any.whl"
...
Обидві перевірки версії мають показати `3.7.9`, а import check —
...
```powershell
& $VenvPython -m pip install "git+https://github.com/weby-homelab/power-framework.git@v3.7.9"
```
...
- `power --version` і distribution metadata повертають `3.7.9`.
