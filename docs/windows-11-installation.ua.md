# Інформаційний гід: встановлення P.O.W.E.R. 3.7.10 на Windows 11 25H2

> **Не є підтримуваною платформою для `v3.7.10`.** Підтримку Windows відкладено
...
> certification для Linux-релізу 3.7.10.

Цей гід встановлює P.O.W.E.R. `v3.7.10` в ізольоване віртуальне середовище,
...
> `v3.7.10` та immutable wheel зі [сторінки релізу GitHub](https://github.com/weby-homelab/power-framework/releases/tag/v3.7.10).
...
- P.O.W.E.R. `v3.7.10` має автоматизований кросплатформний regression-тест
...
Обидві перевірки версії мають показати `3.7.10`, а import check —
...
- `power --version` і distribution metadata повертають `3.7.10`.
