# Інформаційний гід: встановлення P.O.W.E.R. 3.7.7 на Windows 11 25H2

> **Не є підтримуваною платформою для `v3.7.7`.** Підтримку Windows відкладено
...
> certification для Linux-релізу 3.7.7.

Цей гід встановлює P.O.W.E.R. `v3.7.7` в ізольоване віртуальне середовище,
...
> `v3.7.7` та immutable wheel зі [сторінки релізу GitHub](https://github.com/weby-homelab/power-framework/releases/tag/v3.7.7).
...
- P.O.W.E.R. `v3.7.7` має автоматизований кросплатформний regression-тест
...
- Фізичну перевірку Windows 11 25H2 завершено 2026-08-08 для follow-up revision
  ...
  незмінні release-артефакти `v3.7.7`.
...
Обидві перевірки версії мають показати `3.7.7`, а import check —
...
- `power --version` і distribution metadata повертають `3.7.7`.
