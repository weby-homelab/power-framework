# Інформаційний гід: встановлення P.O.W.E.R. 3.7.8 на Windows 11 25H2

> **Не є підтримуваною платформою для `v3.7.8`.** Підтримку Windows відкладено
...
> certification для Linux-релізу 3.7.8.

Цей гід встановлює P.O.W.E.R. `v3.7.8` в ізольоване віртуальне середовище,
...
> `v3.7.8` та immutable wheel зі [сторінки релізу GitHub](https://github.com/weby-homelab/power-framework/releases/tag/v3.7.8).
...
- P.O.W.E.R. `v3.7.8` має автоматизований кросплатформний regression-тест
...
- Фізичну перевірку Windows 11 25H2 завершено 2026-08-08 для follow-up revision
  ...
  незмінні release-артефакти `v3.7.8`.
...
Обидві перевірки версії мають показати `3.7.8`, а import check —
