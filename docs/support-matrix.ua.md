...
Ця матриця визначає операційні межі контракту кандидата релізу `v3.7.3`. Вона
...
але Windows і macOS не входять до межі `v3.7.3` та не мають запланованого
release target.
