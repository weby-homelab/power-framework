...
This is the authoritative clean-install path for P.O.W.E.R. `v3.6.6`. It
...
> **Candidate release contract:** use `v3.6.6` only after its signed tag and immutable
> wheel appear on the [GitHub release page](https://github.com/weby-homelab/power-framework/releases/tag/v3.6.6).
