# P.O.W.E.R. 3.6.2 release notes

P.O.W.E.R. 3.6.2 adds canonical Task v2 and typed decision workflows, strengthens
...
Linux remains the supported release platform for `v3.6.2`. The content-free
upgrade matrix exercises the `3.6.1 -> 3.6.2` state, interrupted-publication,
...
The tag workflow additionally requires a clean signed `v3.6.2` tag, verifies
