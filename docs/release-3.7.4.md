...
> Historical candidate record. Superseded by the corrected unified `v3.7.7`
> release contract in [release-3.7.7.md](release-3.7.7.md); the Suite/GUI pair below is
