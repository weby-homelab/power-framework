...
> Historical candidate record. Superseded by the corrected unified `v3.7.8`
> release contract in [release-3.7.8.md](release-3.7.8.md); the Suite/GUI pair below is
