...
Це авторитетний clean-install шлях для P.O.W.E.R. `v3.7.7`. Він створює лише
...
Обидві команди версії мають показати `3.7.7`, а остання команда —
`lean FTS import: OK`.
...
- CLI та distribution metadata повертають `3.7.7`.
