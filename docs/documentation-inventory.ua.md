...
| `docs/cli.md` | Виконуваний CLI-контракт | 16 команд |
| `docs/mcp-server.md` | Виконуваний MCP-контракт | 17 інструментів |
...
- `12` MCP-інструментів замінено на фактичні `17`; CLI задокументовано як `16`
  топ-рівневих команд.
