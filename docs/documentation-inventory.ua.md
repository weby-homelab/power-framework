...
| --- | --- | --- |
| `README.md` | Англійський огляд і маршрути для агента | Вирівняно з 3.3.2 |
...
| `docs/release-3.3.2.md` | Поточні release notes | Існує; версія збігається з пакетом |
...
| Release wheel `v3.3.2` | Незмінний install artifact | URL відповідав під час аудиту |
...
- Видалено небезпечне оновлення через destructive reset, непереносний `/tmp`,
  ...
  інтерпретатора venv.
- Встановлення прив'язано до release wheel `v3.3.2`, а не до рухомої гілки.
