...
| --- | --- | --- |
| `README.md` | Англійський огляд і маршрути для агента | Вирівняно з 3.4.5 |
...
| `docs/release-3.4.5.md` | Поточні release notes | Існує; версія збігається з пакетом |
...
| Release wheel `v3.4.5` | Незмінний install artifact | URL відповідає release-контракту після публікації |
...
- Видалено небезпечне оновлення через destructive reset, непереносний `/tmp`,
  ...
  інтерпретатора venv.
- Встановлення прив'язано до release wheel `v3.4.5`, а не до рухомої гілки.
